...
export function getSlashCommands(options: SlashCommandOptions = {}): SlashCommand[] {
  ...
  const commands: SlashCommand[] = [
    ...
    { name: "new", description: "Reset session (with AI handoff summary)" },
    { name: "reset", description: "Reset session (with AI handoff summary)" },
    {
      name: "context",
      description: "Load previous session context",
      getArgumentCompletions: (prefix) =>
        ["latest", "list"].filter((v) => v.startsWith(prefix.toLowerCase())).map((value) => ({ value, label: value })),
    },
...
export function helpText(options: SlashCommandOptions = {}): string {
  ...
  return [
    ...
    "/history",
    "/new or /reset (AI-summarized handoff, /new quick to skip)",
    "/context latest (load last session summary)",
    "/context list (show available session summaries)",
    "/abort",
    "/settings",
    "/exit",
  ].join("\n");
