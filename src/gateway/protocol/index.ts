...
import {
  ...
  type SessionsHandoffParams,
  SessionsHandoffParamsSchema,
...
export const validateSessionsHandoffParams =
  ajv.compile<SessionsHandoffParams>(SessionsHandoffParamsSchema);
