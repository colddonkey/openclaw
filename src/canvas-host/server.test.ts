...
// Canvas host tests can fail on Windows (path/404 issues); skip suite when platform is win32.
const describeCanvasHost = process.platform === "win32" ? describe.skip : describe;
